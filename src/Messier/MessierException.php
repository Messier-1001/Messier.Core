...
/**
 * This is the Messier library wide base exception.
 *
 * @since v0.1.0
 */
class MessierException extends \Exception
{
   ...
   /**
    * Init a new MessierException instance.
    *
   ...
   public function getErrorMessage( bool $appendPreviousByNewline = false ) : string
   {
      ...
      if ( $prev instanceof MessierException )
      {
   ...
   public function toCustomString( int $subExceptionLevel = 0, string $indentSpaces = '   ' ) : string
   {
      ...
      if ( $previous instanceof MessierException )
      {
